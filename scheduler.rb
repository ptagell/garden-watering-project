...
# Note: I did this in Ruby rather than using a cron job to control the start time, as it allows me to keep the cron job relatively simple and eventually expand the logic in Ruby to accomodate things like Google Calendar look ups etc. At present this also acts as a failsafe if I get the cron job wrong and stops the garden from being waterede excessively. 
